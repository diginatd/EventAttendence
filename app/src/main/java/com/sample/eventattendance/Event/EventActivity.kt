package com.sample.eventattendance.Event
...
import com.sample.eventattendance.LoginActivity
import com.sample.eventattendance.R
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        doAsync {
            ...
            if (response.body() != null) {
                ...
                uiThread {
                    recyclerView.layoutManager = LinearLayoutManager(this@EventActivity, LinearLayoutManager.VERTICAL, false)
